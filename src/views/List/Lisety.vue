            ...
            >
              <ul class="group">
                <li class="cell" v-for="(i,index) in list" :key="index">
                  <div class="commodity" v-for="(i,index) in commodityy" :key="index">
                    <p class="p1">
       ...
       <van-tab title="价格排序">
           <div id="backpack">
            ...
            >
              <ul class="group">
                <li class="cell" v-for="(i,index) in list" :key="index">
                  <div class="commodity" v-for="(i,index) in commodityyy" :key="index">
                    <p class="p1">
                      <img class="hut" :src="i.cell" />
                      <span class="yaofeng">
                        <img :src="i.cellimg" />
...
export default {
  data() {
    return {
      ...
      commodityy: [
        {
          cell: "/static/img/pad.jpg",
          cellimg: "/static/img/99.png",
          yaofeng: "¥5,170",
          month: "月付",
          price: "¥480.8",
          mkprice: "¥5770",
